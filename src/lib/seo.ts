  ...
  return JSON.stringify({
    ...
    '@graph': [
      ...
      // 3. WebPage
      {
        ...
        'url': 'https://kultalaskuri.fi/',
        'name': 'Kultalaskuri – laske kullan arvo päivän kurssilla',
        'description': 'Ilmainen ja puolueeton kultalaskuri: laske kultakorujen, romukullan tai kultaharkkojen arvo grammoittain päivän kurssilla ja näe reilu tavoitehinta.',
